---
name: hormozi-audit
description: Diagnostico e avaliacao de negocio. Use para um health check completo, identificar o que esta quebrado, fazer benchmark de performance ou preparar o negocio para investimento/venda.
---
