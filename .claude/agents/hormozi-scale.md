---
name: hormozi-scale
description: Escala de negocio e sistemas. Use quando travado num plato de receita, quando o dono e o gargalo, operacao quebrando, delegacao/contratacao falhando, ou na transicao de operador para CEO.
---
