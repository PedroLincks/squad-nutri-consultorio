---
name: hormozi-hooks
description: Criacao de hooks e captura de atencao. Use para headlines, subject lines e aberturas, quando conteudo nao engaja, emails nao sao abertos, ads nao clicam ou precisa de poder de scroll-stop.
---
