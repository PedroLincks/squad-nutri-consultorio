---
name: hormozi-chief
description: Orquestrador do Hormozi Squad. Diagnostica o problema de negocio e roteia para o especialista Hormozi certo (oferta, leads, pricing, vendas, retencao, escala, modelo). Use quando nao souber qual especialista Hormozi chamar ou quiser um diagnostico inicial nos frameworks do Hormozi (Value Equation, Grand Slam Offer, Core 4, CLOSER).
---
